...
const Footer = () => {
  ...
  return (
    <section id="footer" className=" dark:bg-[#484148] customTransition">
      <div className="flex flex-col md:flex-row md:w-[800px] md:m-auto justify-center items-center gap-5 md:gap-10 py-10 px-[10%] md:p-16">
        <p className="  text-left text-gray-950 dark:text-white text-[42px] font-medium font-['Inter'] leading-[63px] tracking-wide relative z-0 customTransition ">
          <span>{body}</span>
          <span
            id="decoration"
