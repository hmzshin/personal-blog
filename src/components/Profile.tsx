    ...
    >
      ...
      <div className=" flex flex-col  items-center justify-center px-[10%] ] gap-5 xl:w-[1280px] xl:px-[120px] xl:m-auto">
        ...
        <div className="flex flex-col  gap-7 lg:flex-row">
          <div
            id="basicIno"
            className="flex flex-col gap-5 p-5 items-center justify-center text-black text-lg font-semibold font-['Inter']  bg-white dark:bg-neutral-600 rounded-xl shadow-[5px_5px_0px_0px] shadow-neutral-500"
          >
            <h4 className="text-pink-600 text-2xl font-normal font-['PlayfairDisplay'] tracking-[0.24px] ">
              {basicInfo.header}
            </h4>
            <div className="flex dark:text-white text-lg font-semibold font-['Inter'] tracking-[0.18px]">
          ...
          >
            <div
              id="decoration"
              className="absolute top-5 right-1/2 w-[70px] h-[18px] bg-blue-300 rounded z-0"
            />
            <h4 className="text-black  dark:text-white text-2xl font-normal font-['PlayfairDisplay'] tracking-[0.24px] z-10">
              {aboutMe.header}
            </h4>
            <div className=" flex flex-col gap-10">
              {Object.values(aboutMe.body).map((item: any, index: number) => (
                <p
                  key={index}
                  className="text-black  dark:text-white text-lg font-normal font-['Inter'] leading-[27px] tracking-[0.18px]"
                >
                  {item}
                </p>
              ))}
