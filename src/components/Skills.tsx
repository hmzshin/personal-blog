...
const Skills = () => {
  ...
  return (
    <section id="skills" className=" ">
      <div className="flex flex-col justify-center items-center gap-5 md:gap-10 py-10 md:py-20  xl:gap-20 bg-grayishYellow  dark:bg-zinc-700 relative customTransition">
        <div
          id="decoration"
        ...
        <h3 className="text-darkCyan dark:text-zinc-100 text-3xl md:text-4xl xl:text-6xl font-medium font-sans tracking-[0.48px] customTransition">
          {language.skills}
        </h3>
